...
// ContentTypeVideoCard is the content type for a video card attachment.
const ContentTypeVideoCard = "application/vnd.microsoft.card.video"

// VideoCard represents a video card.
